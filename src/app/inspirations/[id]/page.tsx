...
export default function InspirationDetail() {
  ...
  return (
    ...
    <div className="max-w-3xl mx-auto space-y-6">
      <button onClick={() => router.back()} className="text-sm text-purple-600 hover:text-purple-800">&larr; {texts.inspBack}</button>
        ...
        <div className="flex flex-col sm:flex-row gap-4 sm:gap-6">
          ...
          <div className="flex-1">
            ...
            <div className="flex flex-wrap gap-2 mt-3">
              ...
              {relatedYarn && (
                <Link href={`/yarns/${relatedYarn.id}`} className="px-3 py-1 rounded-full text-sm bg-purple-100 text-purple-700 hover:bg-purple-200 transition">
                  🧶 {relatedYarn.name}
                </Link>
              )}
            </div>
      ...
      {relatedYarn && (
        <div className="bg-white rounded-2xl p-5 border border-purple-100 shadow-sm">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              <Link href={`/yarns/${relatedYarn.id}`} className="font-semibold text-gray-800 hover:text-purple-600 transition">{relatedYarn.name}</Link>
